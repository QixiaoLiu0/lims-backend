...
public class CocSaveReqDTO {
    ...
    private List<SampleSaveReqDTO> samples;

    public CocSaveReqDTO() {}
    ...
    public List<SampleSaveReqDTO> getSamples() { return samples; }
    public void setSamples(List<SampleSaveReqDTO> samples) { this.samples = samples; }
}